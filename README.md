...
- [p] Un formulario __controlado__ con los siguientes campos
  - Nombre
  - Dificultad
  - Duración
  - Temporada
...
La relación entre ambas entidades debe ser de muchos a muchos ya que un país puede contener varias actividades turísticas y, a su vez, una actividad turística puede darse en múltiples países. Por ejemplo una actividad podría ser "Ski" que podría ocurrir en Argentina y también en Estados Unidos, pero a su vez Argentina podría también incluir "Rafting". -ok

#### Backend

Se debe desarrollar un servidor en Node/Express con las siguientes rutas:

__IMPORTANTE__: No está permitido utilizar los filtrados, ordenamientos y paginados brindados por la API externa, todas estas funcionalidades tienen que implementarlas ustedes. -ok
...
- [x] __POST /activity__:
  ...
  - [x] Crea una actividad turística en la base de datos


#### Testing
- [p] Al menos tener un componente del frontend con sus tests respectivos
- [p] Al menos tener una ruta del backend con sus tests respectivos
- [p] Al menos tener un modelo de la base de datos con sus tests respectivos
